...
/**
 * 内容布局下拉，刷新布局从1/2处开始下拉，下拉速度是内容布局的1/2，下拉完成刚好内容布局位于刷新布局下方
 */
public class RefreshHalfDownSlider implements CustomSwipeRefreshLayout.Slider {
    ...
    public void onLayout(int left, int right, int top, int bottom) {
        ...
        mRefreshView.layout(left + layoutParams1.leftMargin, top - height/2 + mDistance/2, left + measuredWidth + layoutParams1.leftMargin, top + height/2 + mDistance/2);
    }
